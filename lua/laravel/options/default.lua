...
return {
  ...
  providers = {
    ...
    require("laravel.providers.views_provider"),
    require("laravel.providers.override_provider"),
    require("laravel.providers.completion_provider"),
    require("laravel.providers.command_cache_provider"),
    require("laravel.providers.route_info_provider"),
    require("laravel.providers.route_cache_provider"),
    require("laravel.providers.configs_cache_provider"),
    require("laravel.providers.views_cache_provider"),
